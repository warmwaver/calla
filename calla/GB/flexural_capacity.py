...
class fc_T(fc_rect):
    ...
    def solve(self):
        ...
        fy=self.fy; As=self.As; fpy=self.fpy; Ap=self.Ap; α1=self.α1; fc=self.fc
...
class fc_round(abacus):
    ...
    def solve_Mq(α1,fc,fy,r,rs,A,N,M):
        ...
        α = numeric.binary_search_eqs(
                f, x0, x1, α1=α1,fc=fc,fy=fy,r=r,rs=rs,A=A,N=N,M=M)
        Mbc = fc_round.f_M(α,α1,fc,fy,A,N)
        return (α, Mbc)
